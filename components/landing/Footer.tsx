    ...
    <footer className="relative border-t border-white/5">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted leading-relaxed max-w-xs mb-6">
              AI-powered goal tracking that turns your biggest ambitions into daily achievements.
            </p>
            {/* Social Links */}
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-muted hover:text-glow transition-colors duration-200"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="border-t border-white/5 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-muted">
            Made with ⚡ for achievers everywhere.
          </p>
        </div>
      </div>
    </footer>
